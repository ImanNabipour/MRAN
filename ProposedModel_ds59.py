...
N_FEATURE_MAP = 64
LR =  1e-4 # test range:(0.9, 0.1, 0.01, 0.001, 1e-4, 1e-5, 1e-6, 1e-7)
#%% Data Augmentation
...
class Model3DV1(nn.Module):
    def __init__(self, n_channels, n_feature):
        ...
        self._model = nn.Sequential(
            nn.Conv3d(in_channels=n_channels, out_channels=n_feature, kernel_size=7, bias=True),
            ...
            nn.Flatten(),
            nn.Dropout(0.2),
            nn.Linear(in_features=4096, out_features=1), # 2048 for nFeatureMap=32
